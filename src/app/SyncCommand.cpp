...
namespace headmotion::app {
    ...
    namespace {
        ...
        std::string resolveOutputDeviceId(
            ...
            /*
             * Prefer the ID reported by the MMS itself.  Windows does not always
             * expose the USB CDC serial number through SetupAPI, while the board
             * identity response is consistent across platforms.
             */
            ...
            /*
             * Fall back to host USB metadata when the board identity is unavailable.
             */
            device_id =
    ...
    int runSyncCommand(
        ...
        /*
         * Resolve the MMS+ hardware ID before opening the serial port for the
         * MetaWear SDK.  On Windows, probeMmsDevice() cannot open COM13 a second
         * time while the SDK already owns it, which previously caused sync to
         * fall back to filenames such as imu_COM13.csv.
         */
        output.status("resolving_device_id");
